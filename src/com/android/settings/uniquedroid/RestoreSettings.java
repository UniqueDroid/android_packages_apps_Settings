...
public class RestoreSettings extends BroadcastReceiver {
    ...
    private static final String TAG = "UniqueDroid ROM: RestoreSettings";
	...
	Log.d(TAG, "Display color settings restored.");
    ...
    private void configureCPU(Context context) {
        ...
        if (prefs.getBoolean(Processor.SOB_PREF, false) == false) {
            Log.i(TAG, "CPU settings restore disabled by user preference.");
            return;
        }
