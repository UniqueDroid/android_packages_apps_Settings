/*
 * Copyright (C) 2011 The android Project
 *
...
import com.android.settings.uniquedroid.ColorHackUtils;
...
public class GammaTuningPreference extends DialogPreference {
    ...
    public static void restore(Context context) {
        ...
        for (String filePath : FILE_PATH) {
            String sDefaultValue = ColorHackUtils.readOneLine(filePath);
            int iValue = sharedPrefs.getInt(filePath, Integer.valueOf(sDefaultValue));
            ColorHackUtils.writeValue(filePath, String.valueOf((long) iValue));
        }
    }
    ...
    public static boolean isSupported() {
        ...
        for (String filePath : FILE_PATH) {
            if (!ColorHackUtils.fileExists(filePath)) {
                supported = false;
            }
        }
    ...
    class GammaSeekBar implements SeekBar.OnSeekBarChangeListener {
        ...
        public GammaSeekBar(SeekBar seekBar, TextView valueDisplay, String filePath) {
            ...
            // Read original value
            if (ColorHackUtils.fileExists(mFilePath)) {
                String sDefaultValue = ColorHackUtils.readOneLine(mFilePath);
        ...
        public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
            ...
            ColorHackUtils.writeValue(mFilePath, String.valueOf((long) iValue));
            updateValue(iValue);
        }
