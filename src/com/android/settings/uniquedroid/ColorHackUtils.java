...
public class ColorHackUtils {
    private static final String TAG = "ColorHack_Utils";
    private static final String TAG_READ = "ColorHack_Utils_Read";
    private static final String TAG_WRITE = "ColorHack_Utils_Write";
