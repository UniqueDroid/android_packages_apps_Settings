 ...
 * notification volume.
 */
public class ColorPresets extends DialogPreference implements OnClickListener {
    ...
    public ColorPresets(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void WriteMultiplier(Double fValue , int iPos) {
        ...
        ColorHackUtils.writeColor(FILE_PATH_MULTI[iPos], iValue);
        Log.i(TAG,"KalimAz: Multiplier: " + iPos+ " Value " + iValue );
    }

    private void WriteGamma(int iValue , int iPos) {
        ColorHackUtils.writeValue(FILE_PATH_GAMMA[iPos], String.valueOf((long) iValue));
